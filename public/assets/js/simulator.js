...
export function preload() {
    gateIMG.push(loadImage('assets/img/LogicInput.svg'));// For testing usage
    gateIMG.push(loadImage('assets/img/NOT.svg'));
    gateIMG.push(loadImage('assets/img/AND.svg'));
    gateIMG.push(loadImage('assets/img/NAND.svg'));
    gateIMG.push(loadImage('assets/img/OR.svg'));
    gateIMG.push(loadImage('assets/img/NOR.svg'));
    gateIMG.push(loadImage('assets/img/XOR.svg'));
    gateIMG.push(loadImage('assets/img/XNOR.svg'));

    IC_IMG.push(loadImage('assets/img/SR_Latch.svg')); // For testing usage
    IC_IMG.push(loadImage('assets/img/SR_Latch.svg'));
    IC_IMG.push(loadImage('assets/img/SR_Latch_Sync.svg'));
    IC_IMG.push(loadImage('assets/img/FF_D.svg'));
    IC_IMG.push(loadImage('assets/img/FF_D_MS.svg'));
    IC_IMG.push(loadImage('assets/img/FF_T.svg'));
    IC_IMG.push(loadImage('assets/img/FF_JK.svg'));
